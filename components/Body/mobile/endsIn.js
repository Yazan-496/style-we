...
export default function EndsIn({ translations, time, arrow }) {
    ...
    <div className="flex items-center justify-center">
      <p className="asdewqeq">
        <span className="flex items-center gap-1">
          ...
          <span className="text-1xl font-bold w-full text-[#31353c]">:</span>
          <span className="inline-flex gap-0.5">
            <OneTimer number={parseInt(timer[3])} end={2} />
            <OneTimer number={parseInt(timer[4])} end={9} />
          </span>
          <span className="text-1xl font-bold text-[#31353c]">:</span>
          <span className="inline-flex gap-0.5">
