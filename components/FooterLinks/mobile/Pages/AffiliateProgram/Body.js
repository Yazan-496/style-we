  ...
  return (
    <>
      <div className="page-identity-information information">
        ...
        <h4 className="information-name">Affiliate Program</h4>
        <div className="information-content">
          <p />
          <div className="media-wrap image-wrap">
            <img src="/image/catalog/activity/g4awtMJNk01611747942.jpg" />
          </div>
          <p />
          <p />
          ...
          <p className="MsoNormal">
            ...
            to share this passion and new idea to more people, and also make
            more money, what a win-win program!
          </p>
          <p className="MsoNormal">
            We are offering tiered commission rates at 14%, 12%, 10%.
            Non-expiring exclusive coupons/deals, stunning banners, popular
            deals &amp; text links, latest data feedback, etc, are regularly
            provided and updated, aiming to assist our affiliates promote better
            and make more!
          </p>
          <p />
          <p />
          <div className="media-wrap image-wrap">
            <img src="/image/catalog/activity/I5OCQWD1do1611748049.jpg" />
          </div>
          <p />
          <p />
          ...
          <p className="MsoNormal">
            2. High conversion rate due to unique designs and new style
            shopping;
          </p>
          ...
          <p className="MsoNormal">
            Step 1. Choose your affiliate networks and sign up as an affiliate
            or a publisher.
          </p>
          <p className="MsoNormal">
            Step 2. Search our merchant ID within the affiliate platform, or
            click the logo below, you will be redirected to the sign up page.
          </p>
          <p className="MsoNormal">
            Step 3. Apply to join us and wait for our approval.
          </p>
          <p className="MsoNormal">
            Step 4. Get our links to promote for us and watch commissions roll
            in.
          </p>
          <p />
          <p />
          ...
          <div className="media-wrap image-wrap">
            <a
              ...
              target="_blank">
              <img src="/image/catalog/activity/v1gbc7FdSJ1611748112.jpg" />
            </a>
          </div>
          <p className="MsoNormal">
          ...
          <div className="media-wrap image-wrap">
            <a
              ...
              target="_blank">
              <img src="/image/catalog/activity/47R8HDIXoJ1611748112.jpg" />
            </a>
          </div>
          <p>
            <span style={{ color: "#333333" }}>
          ...
          <p className="MsoNormal">
            <span style={{ color: "#0d0d0d" }}>
              ...
              have any other questions about our affiliate program, we will
              always be here to help you get more.
            </span>
          </p>
          <p className="MsoNormal">
            <span style={{ color: "#0d0d0d" }}>
